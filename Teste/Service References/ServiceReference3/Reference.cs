...
namespace Teste.ServiceReference3 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference3.IConsultas")]
    public interface IConsultas {
        ...
        string Rastreamento(string login, string senha, string dataInicial, string dataFinal, int codigoRemetente, int codigoDestinatario, string entregue, string numeroNota, string numeroConhecimento, int codigoCentroCusto, string ufOrigem, int cidadeOrigem, string ufDestino, int cidadeDestino);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultasChannel : Teste.ServiceReference3.IConsultas, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultasClient : System.ServiceModel.ClientBase<Teste.ServiceReference3.IConsultas>, Teste.ServiceReference3.IConsultas {
        ...
        public string Rastreamento(string login, string senha, string dataInicial, string dataFinal, int codigoRemetente, int codigoDestinatario, string entregue, string numeroNota, string numeroConhecimento, int codigoCentroCusto, string ufOrigem, int cidadeOrigem, string ufDestino, int cidadeDestino) {
        ...
        public void RastreamentoAsync(string login, string senha, string dataInicial, string dataFinal, int codigoRemetente, int codigoDestinatario, string entregue, string numeroNota, string numeroConhecimento, int codigoCentroCusto, string ufOrigem, int cidadeOrigem, string ufDestino, int cidadeDestino) {
